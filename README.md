# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/jacoblai/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/jacoblai/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/jacoblai/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/jacoblai/graphql-go) [![GoDoc](https://godoc.org/github.com/jacoblai/graphql-go?status.svg)](https://godoc.org/github.com/jacoblai/graphql-go)
...
- subscriptions
   - [sample WS transport](https://github.com/jacoblai/graphql-transport-ws)

## Roadmap

We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/jacoblai/graphql-go/projects/1).
